...
var AlarmManager = {
  ...
  set: function am_set(alarm, bSnooze, callback) {
    ...
    if (bSnooze) {
      ...
      //console.log(nextAlarmFireTime);
      var hh = nextAlarmFireTime.getHours();
      var mm = nextAlarmFireTime.getMinutes();
      //console.log("hh:mm=",hh+":"+mm+" "+alarm.snooze);
      nextAlarmFireTime.setHours(hh);
      nextAlarmFireTime.setMinutes(mm + parseInt(alarm.snooze));
      nextAlarmFireTime.setSeconds(0);
    } else {
      //console.log("!bSnooze");
      nextAlarmFireTime = getNextAlarmFireTime(alarm);
    }
    
    //console.log("nextAlarmFireTime=",nextAlarmFireTime);
    ...
    request.onsuccess = function(e) {
      ...
      //console.log("alarm=",alarm.snooze);
