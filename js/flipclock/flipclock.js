...
(function($) {
	...
	FlipClock.Factory = FlipClock.Base.extend({
		...
		loadClockFace: function(name, options) {	
			...
			if(FlipClock[name]) {
			  ...
			  //console.log("xxxxxxxxxxxxxxxxxxxxxx"+this.defaultClockFace);
	...
	FlipClock.Face = FlipClock.Base.extend({
      ...
      //console.log("ZZZZZZZZZZZZ",this.factory.classes.label);		
			var dots = [
    ...
    createMdDivider: function(label) {
    ...
    createWeekDivider: function() {
      var w = new Date().getDay();
      //console.log("wwwwwwwwwwwwwwwww",w);
      var html = [
        '<span class="'+this.factory.classes.divider+'">',
        '<img src="images/week/w'+w+'.png" width=60 height=95>',
        '</span>'
      ];  
      //console.log("ZZZZZZZZZZZZ",html);    
      return $(html.join(''));
			...
			for(var x = 0; x < 10; x++) {
			  /*
				...
				*/
				var item = $([
        '<li data-digit="'+x+'">',
            '<div style="width:100%;height:100%;background-image:url(images/flipdate/date-number-mirror-'+x+'.png);background-repeat:no-repeat;background-size: 100% 100%">',
            '</div>',
        '</li>'].join(''));
